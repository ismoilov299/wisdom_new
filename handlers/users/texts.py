...
SENDED_TO_ADMIN = {
    1: "Sizning buyurtmangiz qabul qilindi! Tez orada aloqaga chiqamiz!",
    2: "Ваш заказ принят! Мы свяжемся с вами в ближайшее время!"
}
...
TEXT_ALL = {
    1: "Iltimos, bo'limlardan birini tanlang: 👇",
    2: "Пожалуйста, выберите один из разделов: 👇"
}

TEXT_QUIZ = {
    1:"Iltmos, Test o'tqizmoqchi bo'lgan bo'limgizni tanlang!",
    2:"Пожалуйста, выберите отдел, который вы хотите протестировать!"
}
...
Z_BTN_COMMENTS = {
    1:"✍ Buyurtma haqida izoh qoldirasizmi?",
    2:"✍ Вы оставляете комментарий к заказу?"
}


NO_BTN_COMMENTS = {
    1:"Yo'q, men izoh qoldirmayman",
    2:"Нет, я не оставляю комментарий"
}
...
CART ={
    1:"🗑 Savatga qo'shildi:",
    2:"🗑 В корзину добавлено:"
}
NO_CART ={
    1:"Savatchangiz bo'sh. Siz hech qanday mahsulot tanlamadingiz",
    2:"Ваша корзина пуста. Вы не выбрали ни одного товара"
}
CART_ORDER= {
    1:"Buyurtma qilasizmi?",
    2:"Вы заказываете?"
}
...
NO_ORDERS = {
    1: "Siz xech qanday mahsulotga buyurtma bermadingiz",
    2: "Вы не заказали ни одной продукции"
}
